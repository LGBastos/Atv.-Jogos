...
//		(3) contratorpedeiros (três quadrados) e (4) submarinos (dois quadrados)
	...
	private static int[] checarPontoInicial(Scanner sc, int[][] memoriaTemporariaDePosicao) {
		...
		//dentro do while é usado apenas 1 simbolo "||" , pois caso um dos valores estiver fora do range, ele passa no primeiro teste e nao
...
//				System.out.println();
	...
	//recebe o input e avalia se é uma opção válida
